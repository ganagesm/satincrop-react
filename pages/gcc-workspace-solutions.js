...
const Index = () => {
  return (
    <>
      <WebPageJsonLd
        headline="SAT Advanced Workspace Solutions for Modern Businesses"
        description="Discover how SAT innovative workspace solutions are transforming the modern business environment Explore a range of options from traditional setups to co working and virtual spaces, all designed to boost productivity and collaboration"
        author="SA Technologies"
        keywords="GCC Workspace Solutions"
        image="https://www.satincorp.com/images/banners/LocationSelectionright_img.jpg"
      />
      <NextSeo
        openGraph={{
          type: "website",
          url: "https://www.satincorp.com/gcc-workspace-solutions/",
          title: "SAT Advanced Workspace Solutions for Modern Businesses",
          description:
            "Discover how SAT innovative workspace solutions are transforming the modern business environment Explore a range of options from traditional setups to co working and virtual spaces, all designed to boost productivity and collaboration",
          images: [
            {
              url: "https://www.satincorp.com/images/banners/LocationSelectionright_img.jpg",
              width: 800,
              height: 600,
              alt: "Discover how SAT innovative workspace solutions are transforming the modern business environment Explore a range of options from traditional setups to co working and virtual spaces, all designed to boost productivity and collaboration",
            },
          ],
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content="SAT Advanced Workspace Solutions for Modern Businesses"
          key="title"
        />
        <meta
          name="description"
          content="Discover how SAT innovative workspace solutions are transforming the modern business environment. Explore a range of options from traditional setups to co-working and virtual spaces, all designed to boost productivity and collaboration."
          key="description"
        />
      </Head>
