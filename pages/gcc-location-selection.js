...
import WhyChooseSAT from "../components/GCCLocationSelection/WhyChooseSAT";
import HeroBanner from "../components/GCCLocationSelection/HeroBanner";
import TechDetailsContent from "../components/GCCLocationSelection/TechDetailsContent";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Choose Prime GCC Locations with SAT: Unlock Success"
          key="title"
        />
        <meta
          name="description"
          content="Discover strategic insights to choose the perfect location for your Global Capability Center (GCC). Maximize success"
          key="description"
        />
        <link
          rel="canonical"
          href="https://www.satincorp.com/gcc-location-selection"
        />
      </Head>
