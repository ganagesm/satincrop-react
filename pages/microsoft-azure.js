...
const Index = () => {
  return (
    <>
      ...
      <Head>
        <title>Empowering Your Business with Microsoft's Cloud Solutions</title>
        <meta property="og:title" content="Empowering Your Business with Microsoft's Cloud Solutions" key="title" />
        <meta name="description" content="Unlock limitless possibilities with Microsoft Azure - a comprehensive cloud platform offering scalable solutions for your business needs" key="description" />
      </Head>
