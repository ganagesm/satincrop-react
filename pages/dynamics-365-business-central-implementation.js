  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Dynamics 365 Business Central | SA Technologies Partner"
          key="title"
        />
        <meta
          name="description"
          content="Unlock seamless Business Central Implementation with SA Technologies, a Microsoft Gold Partner. Services include Nav to BC Migration and Integration."
          key="description"
        />
      </Head>
          ...
          <div className="row pb-100 align-items-center">
            <div className="col-lg-7 col-md-7">
              <h2
                ...
                Connect with our Dynamics 365 CRM Expert now
              </h2>
            </div>
            <div
      ...
      <div className="">
        <div className="container">
          <div className="row pt-100 pb-100 align-items-center">
            <div className="col-lg-7 col-md-7">
              <h2
                className="align-items-center"
                style={{
