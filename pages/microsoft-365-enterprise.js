...
import Services from "../components/Microsoft365Enterprise/Services";
import Microsoftservices from "../components/Microsoft365Enterprise/Microsoftservices";
import PageBanner from "../components/Microsoft365Enterprise/PageBanner";
import TechDetailsContent from "../components/Microsoft365Enterprise/TechDetailsContent";
import MainServices from "../components/Live/MainServices";
import BlogPostSlider from "../components/Microsoft365Enterprise/BlogPostSlider";
import ContactFormContent from "../components/Common/ContactFormContent";
import AboutAI from "../components/Microsoft365Enterprise/AboutAI";
import ServicesBox from "../components/Microsoft365Enterprise/ServicesBox";
...
const Index = () => {
  return (
    <>
      ...
      <Head>
        <title>Microsoft 365 Business Plans USA, Compare Pricing and Features</title>
        <meta property="og:title" content="Microsoft 365 Business Plans USA, Compare Pricing and Features" key="title" />
        <meta name="description" content="SA Technologies, premier Microsoft Office 365 license provider in the Bay Area, USA. Explore tailored Business Plans for seamless collaboration and productivity." key="description" />
      ...
      <Navbar />
      <PageBanner
        pageTitle="Revolutionize Your Operations with Microsoft Dynamics ERP"
        homePageUrl="/"
        homePageText="Home"
        activePageText="Microsoft Dynamics ERP "
        bgImgClass="item-bg21"
      />
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="office-business-1">
                <h3 className="">Office 365 E1</h3>

                <div role="presentation" aria-hidden="true">
                  <div className="x-weight-semibold">
                    <span className="price-value " itemProp="price">₹ 942.00 <sup className="price-recurrence">user/month</sup></span>
                  </div>
            ...
            <div className="col-lg-4">
              <div className="office-business-1">
                ...
                <div role="presentation" aria-hidden="true">
                  <div className="x-weight-semibold">
                    <span className="price-value " itemProp="price">₹ 2166.00 <sup className="price-recurrence">user/month</sup></span>
                  </div>
                  <div className="text-center">
                    <span className="price-commitment">(annual commitment)</span>
                    <span className="d-block f-size">GST extra as applicable</span>
            ...
            <div className="col-lg-4">
              <div className="office-business-1">
                ...
                <div role="presentation" aria-hidden="true">
                  <div className="x-weight-semibold">
                    <span className="price-value " itemProp="price">₹ 3582 .00 <sup
