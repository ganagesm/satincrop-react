...
const Index = () => {
  return (
    <>
      <Head>
        <title>
          Microsoft 365 Business Plans USA, Compare Pricing and Features
        </title>
        <meta
          property="og:title"
          content="Microsoft 365 Business Plans USA, Compare Pricing and Features"
          key="title"
        />
        <meta
          name="description"
          content="SA Technologies, premier Microsoft Office 365 license provider in the Bay Area, USA. Explore tailored Business Plans for seamless collaboration and productivity."
          key="description"
        />
        <link
          rel="stylesheet"
