...
import WhyChooseSAT from "../components/GCCLegalRegistrationSupport/WhyChooseSAT";
import HeroBanner from "../components/GCCLegalRegistrationSupport/HeroBanner";
import TechDetailsContent from "../components/GCCLegalRegistrationSupport/TechDetailsContent";
...
const Index = () => {
  return (
    <>
      <WebPageJsonLd
        headline="SAT Seamless Legal Registration Support for Global Capability Centers."
        description="Get expert assistance for hassle free legal registration in Global Capability Centers Ensure compliance and protect your business"
        author="SA Technologies"
        keywords="GCC Legal registration support"
        image="https://www.satincorp.com/images/banners/GCCLegalRegistrationSupport-right.jpg"
      />
      <NextSeo
        openGraph={{
          type: "website",
          url: "https://www.satincorp.com/gcc-legal-registration-support/",
          title:
            "SAT Seamless Legal Registration Support for Global Capability Centers.",
          description:
            "Get expert assistance for hassle free legal registration in Global Capability Centers Ensure compliance and protect your business",
          images: [
            {
              url: "https://www.satincorp.com/images/banners/GCCLegalRegistrationSupport-right.jpg",
              width: 800,
              height: 600,
              alt: "Get expert assistance for hassle free legal registration in Global Capability Centers Ensure compliance and protect your business",
            },
          ],
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content="SAT Seamless Legal Registration Support for Global Capability Centers"
          key="title"
        />
        <meta
          name="description"
