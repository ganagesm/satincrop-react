                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6">
                      <div className="pro_heading">
                        <img style={{width:"200px",}} src="/images/team/Trishita.png" alt="image"/>
                      </div> 
                    </div>

                    <div className="col-lg-9 col-sm-12">
                      <div className="pro_heading_dtl">
                        <h5>Trishita Bhattacharya</h5>
                          <p>Head Client Engagement (APAC)</p>
                      </div>
                      <div className="pro_social">
                        <Link href="mailto:trishita.bhattacharya@satincorp.com" style={{marginTop:"9%", fontWeight:"700",}}>Connect with Sonal</Link>
