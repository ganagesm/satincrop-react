  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Microsoft Azure Services | SA Technologies"
          key="title"
        />
        <meta
          name="description"
          content="Make your organization more efficient and gain agility with our Microsoft Azure Services We focus on finding the right problem and strive to overcome it"
          key="description"
        />
      </Head>
      ...
      <Navbar />
      <PageBanner
        pageTitle="Azure Consulting Services"
        homePageUrl="/"
        homePageText="Home"
