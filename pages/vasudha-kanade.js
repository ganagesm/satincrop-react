                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6">
                      <div className="pro_heading">
                        <img style={{width:"200px",}} src="/images/team/sudha.jpg" alt="image"/>
                      </div> 
                    </div>

                    <div className="col-lg-9 col-sm-12">
                      <div className="pro_heading_dtl">
                        <h5>Vasudha Kanade</h5>
                          <p>Director Finance & Compliance</p>
                      </div>
                      <div className="pro_social">
                        <Link className="btn btn-primary cnt_btn" href="mailto:Vasudha.kanade@satincorp.com" style={{marginTop:"9%", fontWeight:"700",}}><i class="fa-regular fa-envelope"></i> Connect with Vasudha</Link>
                        {/* <Link style={{float: "left", width: "12%",}} href="mailto:Vasudha.kanade@satincorp.com"><p><i class="fa-regular fa-envelope"></i></p></Link> */}
                      </div>
                    </div>
