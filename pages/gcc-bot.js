...
import WhyChooseSAT from "../components/GCCBot/WhyChooseSAT";
import Services from "../components/GCCBot/Services";
import HeroBanner from "../components/GCCBot/HeroBanner";
import TechDetailsContent from "../components/GCCBot/TechDetailsContent";
...
const Index = () => {
  return (
    <>
      <WebPageJsonLd
        headline="Maximizing GCC Efficiency with SAT Build Operate Transfer (BOT) Expertise"
        description="Elevate your Global Capability Center s performance through SAT specialized Build Operate Transfer BOT approach, offering customized solutions for superior business outcomes"
        author="SA Technologies"
        keywords="Build Operate Transfer (BOT)"
        image="https://www.satincorp.com/images/banners/botbanner-right.png"
      />
      <NextSeo
        openGraph={{
          type: "website",
          url: "https://www.satincorp.com/gcc-bot/",
          title:
            "Maximizing GCC Efficiency with SAT Build Operate Transfer (BOT) Expertise",
          description:
            "Elevate your Global Capability Center s performance through SAT specialized Build Operate Transfer BOT approach, offering customized solutions for superior business outcomes",
          images: [
            {
              url: "https://www.satincorp.com/images/banners/botbanner-right.png",
              width: 800,
              height: 600,
              alt: "Elevate your Global Capability Center s performance through SAT specialized Build Operate Transfer BOT approach, offering customized solutions for superior business outcomes",
            },
          ],
      ...
      <Head>
        <title>
          Maximizing GCC Efficiency with SAT Build Operate Transfer (BOT)
          Expertise
        </title>
        <meta
          property="og:title"
          content="Maximizing GCC Efficiency with SAT Build Operate Transfer (BOT) Expertise"
          key="title"
        />
        <meta
          name="description"
