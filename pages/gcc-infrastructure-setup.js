  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Build a Strong GCC Infrastructure with SAT's Expertise"
          key="title"
        />
        <meta
          name="description"
          content="Unlock success by choosing our expert infrastructure setup services for Global Capability Centers. Your path to a robust foundation starts here."
          key="description"
        />
        <link
          rel="canonical"
          href="https://www.satincorp.com/gcc-infrastructure-setup"
        />
      </Head>
