...
import AboutAI from "../components/GCPOffer/AboutAI";
import TopFeaturedSolutions from "../components/GCPOffer/TopFeaturedSolutions";
import CustomerSuccess from "../components/GCPOffer/CustomerSuccess";
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12">
                <div className="ml-main-banner-content">
                  <h1>
                    Google Cloud Platform Offer for{" "}
                    <span>Small and Medium</span> Size Business
                  </h1>
                  <p>
                    Empower your business with advance Google Cloud solutions.
                  </p>
                </div>
              </div>
