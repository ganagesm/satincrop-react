          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="office-business-1">
                ...
                <div className="text-center">
                  <a href="#form" className="smoothScroll scroll-btn discount-btn">Get Upto 20% OFF</a>
                </div>
            ...
            <div className="col-lg-4">
              <div className="office-business-1">
                ...
                <a href="#form" className="btn btn-danger buy-now mt-5 scroll-btn smoothScroll d-block text-center w-50 mx-auto">
                  Buy Now</a>
              </div>
            </div>
            <div className="col-lg-4">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 middle-scroll offer-content  d-flex flex-column justify-content-center align-items-center">
              ...
              <a href="#form" className=" scroll-btn smoothScroll">Contact Now</a>
            </div>
          </div>
        </div>
      </section>
