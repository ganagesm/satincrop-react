...
const GoogleEducation = () => {
  return (
    <>
      <Head>
        <title>Upgrade Your Education System With Google for Education by SAT</title>
        <meta property="og:title" content="Upgrade Your Education System With Google for Education by SAT" key="title" />
        <meta name="description" content="Google for Education is a suite specially for Education environments that helps upgrade your digital environment with advanced, security, and productivity tools." key="description" />
      </Head>

      <Navbar />
      <PageBanner
        pageTitle="Empowering Education with Google: Transform Teaching and Learning"
        homePageUrl="/"
          ...
          <div className="row ptb-100 pb-100 align-items-center">
            <div className="col-lg-7 col-md-8">
              <h2 className="align-items-center"
                style={{textAlign: "",}}> 
                Let’s Work Together, Elevate Your Educational Environment with us. 
              </h2>
            </div>
      ...
      <div className="section-title pt-100">
        <h4>Connect and empower your school community with Google for Education. Select the edition that best
           fits your educational needs and start transforming the way you teach and learn. </h4>
