...
const Index = () => {
  return (
    <>
      <WebPageJsonLd
        headline="SAT GCC Talent Acquisition: Streamlined Hiring Solutions"
        description="Streamline your hiring process with our Talent Acquisition Services for Global Capability Centers Get the right talent on board quickly and efficiently"
        author="SA Technologies"
        keywords="GCC talent aquisition"
        image="https://www.satincorp.com/images/banners/GCCTalentAcquisition-right.jpg"
      />
      <NextSeo
        openGraph={{
          type: "website",
          url: "https://www.satincorp.com/gcc-talent-acquisition/",
          title: "SAT GCC Talent Acquisition: Streamlined Hiring Solutions",
          description:
            "Streamline your hiring process with our Talent Acquisition Services for Global Capability Centers Get the right talent on board quickly and efficiently",
          images: [
            {
              url: "https://www.satincorp.com/images/banners/GCCTalentAcquisition-right.jpg",
              width: 800,
              height: 600,
              alt: "Streamline your hiring process with our Talent Acquisition Services for Global Capability Centers Get the right talent on board quickly and efficiently",
            },
          ],
      ...
      />
      <Head>
        <title>SAT GCC Talent Acquisition: Streamlined Hiring Solutions</title>
        <meta
          property="og:title"
          content="SAT GCC Talent Acquisition: Streamlined Hiring Solutions"
          key="title"
        />
        <meta
          name="description"
