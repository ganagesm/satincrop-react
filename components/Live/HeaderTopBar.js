          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-lg-6 col-md-6">
              <ul className="topbar-action-list">
                {/* <li>
                  PartnerContent
                  <i className="fa-solid fa-location-pin"></i> 2750 Quadra Street Victoria, Canada
                </li>
                <li>
                ...
                <li><a href="https://www.facebook.com/satincorp" target="_blank" rel="noreferrer"><i className="fab fa-facebook-f"></i></a></li>
                <li><a href="https://twitter.com/SatechGlobal" target="_blank" rel="noreferrer"><i className="fab fa-twitter"></i></a></li>
                <Translation />
              </ul>
            </div>
          </div>
