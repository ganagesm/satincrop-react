            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div
                ...
                <div className="logo">
                  ...
                  <p>
                    {" "}
                    SAT Inc is a California based IT Consulting & Offshore
                    Company headquartered at Santa Monica with offices in US,
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div
                ...
                <ul className="quick-links-list">
                  <li>
                    <Link href="/gcc-operations"> GCC Operations </Link>
                  </li>
                  <li>
                    <Link href="/customized-workspaces">
                      Customized Workspaces
                    </Link>
                  </li>
                  <li>
                    <Link href="/build-operate-transfer">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div
                ...
                <ul className="footer-contact-list">
                  ...
                  <li>
                    <span>Email:</span>
                    <a href="mailto:sales@satincorp.eu">sales@satincorp.eu</a>
                  </li>
                  <li>
                    <span>Phone:</span>
