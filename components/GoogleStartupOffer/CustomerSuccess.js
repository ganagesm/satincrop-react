                  ...
                  <div className="row justify-content-center">
                    <SwiperSlide>
                      <div className="">
                        <div className="entry-post-content">
                          <p>
                            {" "}
                            SAT helped a retail company implement Google Cloud's
                            data analytics and machine learning services to get
                            insights from its customer data. The company has
                            been able to use these insights to improve its
                            marketing campaigns and product development efforts.
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide>
                      <div className="">
                        <div className="entry-post-content">
                          <p>
                            SAT helped a healthcare company develop a new
                            cloud-native application for managing patient
                            records. The application was developed and deployed
                            in just three months, and it has helped the company
                            to improve its operational efficiency and patient
                            care.
                          </p>
                        </div>
                      </div>
