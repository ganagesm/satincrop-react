          ...
          <div className="row justify-content-center">
            <div className="col-lg-12 col-sm-12">
              <div style={{textAlign:"center",}} className="top-featured-content">
                <h2>Overview</h2>
                <p>In the ever-evolving semiconductor sector, our comprehensive MES solutions streamline operations, while integrated supply chain management ensures timely material deliveries for seamless production. Our quality assurance services maintain product integrity, bolstering brand reputation in a dynamic market.  
</p>
              </div>
            </div>
