                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p>We create inspiring workspaces that enhance well-being and productivity. </p>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p>Seamlessly integrate advanced technology for modern operations.</p>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p>Eco-friendly practices and green tech reduce environmental impact. </p>
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p>Optimize energy use, enhance security, and ensure comfort.</p>
                    </div>
                  </div>
                </div>
