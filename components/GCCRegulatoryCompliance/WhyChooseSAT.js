          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="computer-vision-ai-content">
                 <h3>Our Proactive Measures: Navigating Compliance to Strengthen Your GCC </h3> 
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      <div className="">
                        <h4>Our Proactive Measures </h4>
                      </div>
                      <p>Navigating Compliance to Strengthen Your GCC </p>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p>We provide tailored training to enhance your team's understanding. </p>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p> Regular audits ensure continuous compliance with standards.</p>
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p> We develop personalized plans aligned with your operations.</p>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="vision-ai-inner-card">
                      ...
                      <p>Proactive assessment and mitigation safeguard your operations. </p>
                    </div>
                  </div>
                </div>
