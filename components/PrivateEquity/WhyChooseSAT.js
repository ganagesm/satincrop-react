        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="computer-vision-ai-content">
                ...
                <p>
                  Maximize your investment potential with SA Technologies'
                  tailored IT services. We support Private Equity Groups by
                  managing cybersecurity risks to enhance operational
                  performance and safety, regardless of investment scale.
                </p>
                <p>
                  Strong cybersecurity practices are essential for Private
                  Equity firms, which conduct thorough IT assessments before
                  finalizing deals to reduce risks and improve efficiency. As
                  cybersecurity threats evolve, small or new companies face
                  increased risks, making a comprehensive cybersecurity plan
                  crucial for protecting investments.{" "}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center pt-100">
            <div className="col-lg-6 col-md-6">
              <div className="computer-vision-ai-content">
                <h4 style={{ fontSize: "30px" }}>
                  Hybrid Cloud for Private Equity Firms
                </h4>
                <p>
                  SA Technologies offers Hybrid Cloud solutions that boost
                  security, performance, and efficiency in IT operations for PE
                  companies. By migrating more business applications to the
                  Cloud, private equity firms can better manage evolving needs
                  such as remote workforces, IT resource constraints, and
                  adjustments to physical office spaces.{" "}
                </p>
              </div>
            </div>
            <div className="col-lg-6 col-md-12">
          ...
          {/* <div className="row align-items-center pt-100">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="computer-vision-ai-content">
                <h4 style={{fontSize: "30px"}}>Managed Detection and Response for Private Equity Firms </h4>
          ...
          <div className="row align-items-center pt-100">
            <div className="col-lg-6 col-md-6">
              <div className="computer-vision-ai-content">
                <h4 style={{fontSize: "30px"}}>Vulnerability Scanning and Management for Private Equity Firms  </h4>
          ...
          <div className="row align-items-center pt-100">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="computer-vision-ai-content">
                <h4 style={{fontSize: "30px"}}>Disaster Recovery-as-a-Service for Private Equity </h4>
