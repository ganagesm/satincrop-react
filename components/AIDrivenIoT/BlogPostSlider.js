  ...
  useEffect(() => {
    async function fetchPosts() {
      try {
        ...
        const response = await fetch(`${postApi}/posts?categories=346&page=${currentPage}&per_page=${pageSize}&order=desc`);
                  ...
                  <div className="single-blog-post" key={index}>
                    ...
                    <div className="entry-post-content">
                      ...
                      <h3>
                        ...
                        <div dangerouslySetInnerHTML={{ __html: post.title.rendered.slice(0, 60) + '...' }}/>
                      </h3>
